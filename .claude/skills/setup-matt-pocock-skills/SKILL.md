...
- **Issue tracker** — where issues live (GitHub; this repo is GitHub-only)
...
Default posture: this repo tracks work in GitHub Issues, so propose that. If the user tracks work elsewhere, offer:
