...
3. Write the PRD using the template below.
   ...
   **Pipeline mode** — when operating within the planning pipeline (docs/agents/planning-pipeline.md), you are on a branch tied to a planning ticket. Write the PRD to docs/planning/<ticket>/prd.md and commit it on the branch instead of filing it as an issue. It is reviewed in the branch's draft PR; implementation issues are broken out with `to-issues` after merge. <ticket> is the kebab-case branch name.
