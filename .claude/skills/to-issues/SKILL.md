...
When breaking out a planning-pipeline PRD (docs/planning/<ticket>/prd.md), set the Parent of every spawned issue to the PRD issue — not the planning ticket. The PRD is what links back to the planning ticket; the sub-tickets hang off the PRD.
