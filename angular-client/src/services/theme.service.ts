...
export default class Theme {
  ...
  static readonly infoValueLarge: string = this.boldedText + 'fontSize: 3.25rem; margin: 0; align-self: center';
  static readonly infoUnitSmall: string = this.textStyle + 'font-size: 1rem; color: gray; padding-top: 17px;';
  static readonly infoUnitLarge: string = this.textStyle + 'font-size: 1.75rem; color: gray; padding-top: 30px;';
